...
public class BookList implements Serializable
{
    ...
    public ArrayList<Book> getDummyData()
    {
        ...
        //ANDROID
        localListOfBooks.add(new Book("Amazon", "Android Programming: The Big Nerd Ranch Guide", "9780134706054", "Bill Phillips, Chris Stewart, Kristin Marsicano", "Edition 3", 44.99, "Android.jpg"));
        ...
        localListOfBooks.add(new Book("Chegg", "Android Programming: The Big Nerd Ranch Guide", "9780134706054", "Bill Phillips, Chris Stewart, Kristin Marsicano", "Edition 3", 42.99, "Android.jpg"));
        localListOfBooks.add(new Book("Cengage", "Android Programming: The Big Nerd Ranch Guide", "9780134706054", "Bill Phillips, Chris Stewart, Kristin Marsicano", "Edition 3", 44.99, "Android.jpg"));
        localListOfBooks.add(new Book("Downtown Bookstore", "Android Programming: The Big Nerd Ranch Guide", "9780134706054", "Bill Phillips, Chris Stewart, Kristin Marsicano", "Edition 3", 39.99, "Android.jpg"));
        ...
        //NETWORK
        localListOfBooks.add(new Book("Amazon", "Computer Networking: A Top-Down Approach", "9780132856201", "Jim Kurose, Keith Ross", "Edition 6", 49.99, "Networking.jpg"));
        localListOfBooks.add(new Book("Cengage", "Computer Networking: A Top-Down Approach", "9780132856201", "Jim Kurose, Keith Ross", "Edition 6", 59.99, "Networking.jpg"));
        ...
        localListOfBooks.add(new Book("Downtown Bookstore", "Computer Networking: A Top-Down Approach", "9780132856201", "Jim Kurose, Keith Ross", "Edition 6", 44.99, "Networking.jpg"));
        ...
        localListOfBooks.add(new Book("HUB Bookstore", "Charlas de Sobremesa: Conversación en Español", "9780300191622", "Teresa Carballal, Margarita Ribas Groeger", "Edition 1", 69.99, "Charlas.jpg"));
